class User < ApplicationRecord
  ...
  validates :email,               presence: true#, uniqueness: true, format: { with: /\A[a-z\d]@[a-z\d]\z/ }
  validates :password,            presence: true, format: { with: PASSWORD_REGEX }, length: { minimum: 6 }, confirmation: true
